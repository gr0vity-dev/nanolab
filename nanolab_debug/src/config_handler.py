...
from nanolab_debug.src.utils import download_data
from nanolab_debug.src.github import GitHubAPI
...
class ConfigResourceHandler():
    ...
    def download_and_replace_resources(self, config_path: Path,
        ...
        for key, value in global_resources.items():
            ...
            if value_string.startswith("http://") or value_string.startswith("https://"):
